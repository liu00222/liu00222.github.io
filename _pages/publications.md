...
**Yupei Liu**, Yuqi Jia, Neil Zhenqiang Gong, and Jinyuan Jia. "LongPIBench: A Long-Context Benchmark for Prompt Injection". In *Findings of Empirical Methods in Natural Language Processing (EMNLP)*, 2026.
...
Yuqi Jia, Zedian Shao, **Yupei Liu**, Jinyuan Jia, Dawn Song, and Neil Zhenqiang Gong. "A Critical Evaluation of Defenses against Prompt Injection Attacks". In *ACM Symposium on Access Control Models and Technologies (SACMAT)*, 2026. 
